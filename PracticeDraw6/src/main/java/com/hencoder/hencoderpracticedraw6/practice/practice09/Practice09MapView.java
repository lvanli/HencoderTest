...
public class Practice09MapView extends View {
    ...
    public Practice09MapView(Context context) {
        super(context);
    }

    public Practice09MapView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice09MapView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
