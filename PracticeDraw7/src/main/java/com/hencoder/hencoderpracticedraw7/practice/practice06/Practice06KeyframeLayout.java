    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe first = Keyframe.ofFloat(0f, 0);
                Keyframe second = Keyframe.ofFloat(0.5f, 100);
                Keyframe third = Keyframe.ofFloat(1f, 80);
                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress", first, second, third);
